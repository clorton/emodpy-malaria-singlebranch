...
def set_vsp(config, manifest):
    ...
    vsp2 = vector_config.set_genetics(vsp2, manifest)  # , alleles, allele_inits )
    ...
    vsp3 = vector_config.set_genetics(vsp3, manifest)  # , alleles, allele_inits )
