...
def build_camp():
    ...
    dc.add_drug_campaign( camp, "MDA", "AL", trigger_condition_list=[ "NewInfectionEvent" ], triggered_campaign_delay=44 )
    return camp
...
def build_demog():
    ...
    demog = Demographics.from_template_node( lat=1, lon=2, pop=12345, name="Atlantic Base", forced_id=321, init_prev=0.1 )
    return demog
